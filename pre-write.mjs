...
//
// Per docs/history/phases/p1/p1-1.md §4.1 Option A, this CLI is the EXPLICIT dispatch —
...
import { validateIntent } from './_lib/pre-write-intent.mjs';
import { lookupName } from './_lib/pre-write-lookup-name.mjs';
import { lookupFile } from './_lib/pre-write-lookup-file.mjs';
import { lookupDependency } from './_lib/pre-write-lookup-dep.mjs';
import { lookupShape } from './_lib/pre-write-lookup-shape.mjs';
import { lookupInlinePatterns } from './_lib/pre-write-lookup-inline-patterns.mjs';
...
} from './_lib/function-signature-hash.mjs';
...
const advisory = {
  ...
  boundaryChecks: [],  // P1-2 keeps empty — NOT_EVALUATED entries are
                       // optional and omitted by default (docs/history/phases/p1/p1-2.md §4.5).
  drift,
