...

{
  ...
  try {
    ...
    assert(
      "audit-repo forwards --no-incremental to build-symbol-graph",
...

{
  ...
  try {
    ...
    assert(
      "audit-repo forwards --cache-root to build-symbol-graph",
      path.resolve(symbols.meta.incremental?.cacheRoot ?? "") ===
