...

{
  ...
  assert(
    "CK-12a. audit-repo.mjs delegates check-canon lifecycle to audit-core wrapper",
  ...
  assert(
    "CK-12b. check_canon_lifecycle.rs owns CHECK_CANON_SOURCES",
