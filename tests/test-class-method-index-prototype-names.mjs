...
assert('CM-PROTO1. classMethodIndex accepts prototype method names without crashing',
  !thrown,
  thrown?.stack ?? '');

const index = artifact?.classMethodIndex?.['src/prototype-methods.ts'] ?? {};
assert('CM-PROTO2. classMethodIndex stores prototype-named methods as own keys',
