...
**Evidence sources:** `triage.json.topDirs{}` shape. Healthy: top-dirs with meaningful names (`apps/`, `packages/`, `_lib/`). Anti-pattern: everything at root, no apparent layering.
