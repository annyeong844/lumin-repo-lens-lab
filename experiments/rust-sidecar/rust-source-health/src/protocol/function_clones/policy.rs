...
pub struct AstNearFunctionCandidatePolicy {
    ...
    pub idf_weighted_call_tokens: bool,
...
impl Default for AstNearFunctionCandidatePolicy {
    fn default() -> Self {
        Self {
            ...
            idf_weighted_call_tokens: RUST_FUNCTION_CLONE_NEAR_IDF_WEIGHTED_CALL_TOKENS,
            ...
            min_call_token_jaccard: RUST_FUNCTION_CLONE_NEAR_MIN_CALL_TOKEN_JACCARD,
