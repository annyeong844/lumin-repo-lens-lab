...
use crate::protocol::{
    ...
    RUST_FUNCTION_CLONE_NEAR_CANDIDATE_GENERATION_MODE, RUST_FUNCTION_CLONE_NEAR_MAX_CANDIDATES,
    ...
    RUST_FUNCTION_CLONE_NEAR_NAME_TOKEN_WEIGHT, RUST_FUNCTION_CLONE_NEAR_PAIR_DEDUPE,
    RUST_FUNCTION_CLONE_NEAR_POLICY_CLASS, RUST_FUNCTION_CLONE_NEAR_POLICY_ID,
    RUST_FUNCTION_CLONE_NEAR_POLICY_VERSION, RUST_FUNCTION_CLONE_NEAR_PROJECTION,
    RUST_FUNCTION_CLONE_NEAR_REQUIRED_MATCHING_QUALIFIERS,
    RUST_FUNCTION_CLONE_NEAR_RETRIEVAL_CONTRACT_VERSION,
...
impl Default for AstNearFunctionCandidatePolicy {
    fn default() -> Self {
        Self {
            ...
            candidate_generation_mode: RUST_FUNCTION_CLONE_NEAR_CANDIDATE_GENERATION_MODE,
