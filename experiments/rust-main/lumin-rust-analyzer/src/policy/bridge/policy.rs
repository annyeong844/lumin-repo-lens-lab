...
pub(super) struct OracleBridgePolicy {
    ...
    calibration_reason: OracleBridgeCalibrationStatusReason,
...
impl OracleBridgePolicy {
    pub(super) fn from_action_policy(
        ...
        let calibration_status = if calibration_adjudication.is_some() {
            CalibrationStatus::Measured
        } else {
            CalibrationStatus::Pending
        };
        let calibration_reason = if calibration_adjudication.is_some() {
    ...
    pub(super) fn bridge_projection(self) -> OracleBridgePolicyProjection {
        OracleBridgePolicyProjection {
            ...
            calibration: self.calibration_projection(),
        }
    }

    fn calibration_projection(self) -> OracleBridgeCalibrationProjection {
