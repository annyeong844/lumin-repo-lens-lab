...
use oxc_ast::ast::{
    ...
    ExportDefaultDeclarationKind, ExportNamedDeclaration, Expression, ImportDeclarationSpecifier,
    ImportOrExportKind, MemberExpression, MethodDefinitionKind, ModuleExportName, Program,
    PropertyKey, SimpleAssignmentTarget, Statement, TSAccessibility, VariableDeclaration,
