pub(super) const USAGE: &str = r#"usage: lumin-audit-core artifact-registry --output <dir> [--rust-analysis-ran|--rust-analysis-block <path|->]
       ...
       lumin-audit-core manifest-evidence-summary --root <repo> --output <dir> [--generated-artifacts <default|present|prepared>] [--include-tests|--no-include-tests] [--production|--no-production] [--rust-analysis-ran] [--exclude <path> ...] [--auto-exclude <path> ...]
