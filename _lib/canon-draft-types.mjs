...
// Exported top-level type declarations per docs/spec/SPEC-canon-generator.md §2.1.
...
/**
 * Render type ownership to Markdown per docs/spec/SPEC-canon-generator.md v0.2.2 §6.
 */
