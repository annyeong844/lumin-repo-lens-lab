...
//     canonical/pre-write-gate.md §8 + docs/history/phases/p1/session.md §5.3)
//   - pre-write drift warning (docs/history/phases/p1/session.md §5.9)
//
...
// `generate-canon-draft.mjs` per docs/spec/SPEC-canon-generator.md §6. Anything
...
// source attribution. Matches the docs/spec/SPEC-canon-generator.md §6 emission
