...
`this file is generated` within the first 2048 source bytes. Generated-only
clone groups remain raw evidence but do not increment review-visible group or
near-candidate counts.
