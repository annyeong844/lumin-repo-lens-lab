...
| `_lib/block-clone-artifact.mjs`                                                | JS/TS OXC parsing, normalized block-clone token production, and request-side policy identifiers/defaults | suffix-array/LCP construction, repeated-region grouping, containment pruning, noise/cap policy, final artifact projection, or a JS fallback artifact owner |
