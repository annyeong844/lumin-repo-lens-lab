...
> **Owner:** this file.
> **Status:** spine v2 (rewritten 2026-04-20 after external review of v1).
...
- **Per-identity annotation** — extend `_lib/extract-ts.mjs` (or sibling `_lib/extract-ts-contamination.mjs`) to annotate each extracted `def` with the `anyContamination` object defined in §4. Omit when clean.
